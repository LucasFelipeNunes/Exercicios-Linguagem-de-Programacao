...
Enunciado: Crie um arquivo chamado ValorNull.java. Implemente um programa em Java que declare uma
...
public class ValorNull 
{
	public static void main (String[] args)
	{
		...
		System.out.println("O número inicialmente e " + numero);
		numero = null;
		System.out.println("O número posteriormente e " + numero);
	}
}
